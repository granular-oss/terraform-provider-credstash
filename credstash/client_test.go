...
// 		// 	if aws.StringValue(in.version) != "test_table" {
...
// 	result, err := c.GetSecret("test_key", "", c.PaddedInt(1), nil)
// 	assertNoError(t, err)

// 	if result.Secret != password {
// 		t.Errorf("decrypt failed.\nexpected result: %s\ngot: %s", password, result.Secret)
// 	}
// }
...
// 	testPutItemInput func(*dynamodb.PutItemInput)
...
// func (db fakeDynamoDB) DeleteItem(in *dynamodb.DeleteItemInput) (*dynamodb.DeleteItemOutput, error) {

// 	return &dynamodb.DeleteItemOutput{}, nil
// }

// func (db fakeDynamoDB) PutItem(in *dynamodb.PutItemInput) (*dynamodb.PutItemOutput, error) {
// 	if db.testPutItemInput != nil {
// 		db.testPutItemInput(in)
// 	}
...
// func (d fakeDecrypter) GenerateDataKey(in *kms.GenerateDataKeyInput) (*kms.GenerateDataKeyOutput, error) {
// 	return &kms.GenerateDataKeyOutput{
// 		CiphertextBlob: []byte("d.plaintext"),
// 		Plaintext:      d.plaintext, // return the plain text key after generation
// 	}, nil
// }
